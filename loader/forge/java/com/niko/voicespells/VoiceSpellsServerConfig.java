...
public final class VoiceSpellsServerConfig {
    ...
    public static final class Server {
        ...
        public final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> playerAdvantages;
        ...
        Server(ForgeConfigSpec.Builder b) {
            ...
            b.comment("Make the voice level bonus depend on how loudly the spell was said.",
                      ...
                      "     playerAdvantages level) on top of the level the item itself would",
                      "     have cast at.",
                      "On:  that bonus has to be earned - a whisper earns none of it, your normal",
                      "     speaking voice about half, a raised voice all of it.",
                      "The level the item itself would cast at - the spellbook, the imbued item or",
                      "the scroll, affinity curios included, and 1 under FREE - is always the",
                      "FLOOR. Loudness only decides how much is added on top of it, so a bad",
                      "reading can never make a spoken cast weaker than clicking the same item.",
            ...
            b.comment("Whether spells may be cast WITHOUT speaking them.",
                      ...
                      "Applies to players who have Incantation installed, checked at login by",
                      "whether their connection negotiated the mod's channel. Someone without the",
                      "mod cannot speak a spell, so requiring it would brick them with no way to",
                      "comply - they are left alone instead. Same for anyone excluded by",
                      "voiceAllowedPlayers, who is forbidden to speak and so cannot be required to.",
                      "",
                      "FIRST_CAST unlocks are per world, stored in <world>/voicespells/learned.txt,",
                      "and written the moment a spell is unlocked so a crash cannot take them back.",
                      "",
                      "Casts that no player initiated - command blocks, datapacks, /cast, mobs -",
                      "are never affected.");
